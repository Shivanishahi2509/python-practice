...
# 2. Clean data
# Filter out top 2.5% and bottom 2.5%
df = df[
...
def draw_bar_plot():
    ...
    # Draw bar plot
    # We group by year and month, then unstack to get months as columns
    ...
    fig = df_pivot.plot(kind='bar', figsize=(15, 7), legend=True).figure
    plt.xlabel('Years')
